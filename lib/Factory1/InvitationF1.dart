...
class InvitationF1 extends StatelessWidget {
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      context.read<UserProvider>().addContact(name: ownerNameController.text, phoneNum: ownerNameController.text);// Execute the submit method
